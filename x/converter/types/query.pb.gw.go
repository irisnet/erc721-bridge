...
// source: converter/v1/query.proto
...
var (
	...
	pattern_Query_TokenTrace_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"evmos", "ERC721", "v1", "token_trace", "class_id", "token_id"}, "", runtime.AssumeColonVerbOpt(false)))
)
